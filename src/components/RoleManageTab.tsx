...
const ACTION_PERMISSION_OPTIONS = [
  ...
  { label: '采购付款确认', value: 'purchases:payment_confirm' },
  { label: '采购删除', value: 'purchases:delete' },
  ...
  { label: '新功能通知管理', value: 'announcements:manage' },
  { label: '供应商管理', value: 'settings:supplier_manage' },
