...
**2026-06-12 09:25**
- ✅ 部署 hc-admin-009 版本
- ✅ 订单来源/属性/渠道/品牌必填校验 + 红色星号标识
- ✅ 订单来源与订单类型联动过滤（新增→新增业务，服务→租后4类）
- ✅ 数量/单价/租期/租金 min=0 + Math.max(0,...) 兜底
- ✅ 收款账户新增 YYFISH/XXFISH/HHFISH/未收款
- ✅ 金额>0时收款账户条件必填
- ✅ 邮寄费用→邮寄结算方式，改为必填
- ✅ 租后发货/退货归还状态功能（已退回/运输途中/未退回）
- ✅ 未收款/运输途中/未退回订单红色高亮提示
- ✅ 发票编辑支持修改附件（增删）
- ✅ 更新云函数 countPendingInvoices

**2026-06-11 15:47**
- ✅ 部署 hc-admin-008 版本
- ✅ 编辑订单复用新建订单6步向导UI
- ✅ 订单列表显示中文label而非key
- ✅ Excel导出订单使用中文label而非key
- ✅ 人员列表增加HH

**2026-06-10 20:32**
- ✅ 部署 hc-admin-007 版本
- ✅ 新增订单创建规则文件（.codebuddy/rules/order-create-rules.md）
- ✅ 修复和完善订单、发票、公司管理等功能
